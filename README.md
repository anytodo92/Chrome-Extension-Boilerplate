...
Chrome Extension is the app for Job Hunters. It helps writing resumes, interviewing with clients, writing a proposal. 
...
- `content.ts` - the [content script](https://developer.chrome.com/docs/extensions/mv3/content_scripts/) to be run in the context of selected web pages
- `background.ts` - the [background script](https://developer.chrome.com/docs/extensions/mv3/service_workers/) usually used to initialize the extension and monitor events
